      ...
      <div className="container d-flex justify-content-around">
        <div>
          ...
          >
            ...
            <tbody>
              {this.state?.tableDetailData &&
                this.state?.tableDetailData?.tableProducts?.map((item) => (
                  ...
                  <tr key={item.OrderPartID}>
                    ...
                    <td
                      ...
                      onClick={(orderpartID) => {
                        this.handleClickAdd(item.OrderPartID);
                      }}
                    >
                      {" "}
                    ...
                    <td
                      ...
                      style={{ cursor: "pointer", fontWeight: "bold" }}
                      onClick={(orderpartId) => {
                        this.handleClickSub(item.OrderPartID);
                      }}
                    >
                      <button className="rounded text-center btn btn-outline-dark btn-sm fw-bold border">
                        -
           ...
           <div key={item.TableID}> Sub Total: ${item.CurrentTotal}  </div>)
              ...
              <div>
                <button className="btn btn-md btn-outline">
                  <Link className="textLink" to="/payment">
                    Pay
                  </Link>
                </button>
              </div>
